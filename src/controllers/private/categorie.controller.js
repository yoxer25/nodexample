...
export const getCategories = async (req, res) => {
  ...
  if (user.user !== null) {
    try {
      ...
      res.render("private/categories/index", { user, categories });
    } catch (error) {
      const msg = error.message;
      res.redirect("/private/categoria");
    }
  } else {
    res.redirect("/");
  }
...
export const getCategorieById = async (req, res) => {
  ...
  if (user.user !== null) {
    ...
    try {
      ...
      res.render("private/categories/update", {
        user,
...
export const updateCategorieById = async (req, res) => {
  ...
  if (user.user !== null) {
    ...
    try {
      ...
      const msg = error.message;
      res.redirect(`/private/categoria/update/${Id}`);
    }
  } else {
    res.redirect("/");
  }
